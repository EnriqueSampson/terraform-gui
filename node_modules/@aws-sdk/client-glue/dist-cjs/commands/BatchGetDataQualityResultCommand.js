...
exports.BatchGetDataQualityResultCommand = exports.$Command = void 0;
...
class BatchGetDataQualityResultCommand extends smithy_client_1.Command
    ...
    .f(void 0, void 0)
    .ser(Aws_json1_1_1.se_BatchGetDataQualityResultCommand)
    .de(Aws_json1_1_1.de_BatchGetDataQualityResultCommand)
    .build() {
}

...
exports.BatchGetCustomEntityTypesCommand = exports.$Command = void 0;
...
class BatchGetCustomEntityTypesCommand extends smithy_client_1.Command
    ...
    .f(void 0, void 0)
    .ser(Aws_json1_1_1.se_BatchGetCustomEntityTypesCommand)
    .de(Aws_json1_1_1.de_BatchGetCustomEntityTypesCommand)
    .build() {
}

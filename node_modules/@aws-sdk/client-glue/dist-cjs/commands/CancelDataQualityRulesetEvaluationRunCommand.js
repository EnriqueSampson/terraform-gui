...
exports.CancelDataQualityRulesetEvaluationRunCommand = exports.$Command = void 0;
...
class CancelDataQualityRulesetEvaluationRunCommand extends smithy_client_1.Command
    ...
    .f(void 0, void 0)
    .ser(Aws_json1_1_1.se_CancelDataQualityRulesetEvaluationRunCommand)
    .de(Aws_json1_1_1.de_CancelDataQualityRulesetEvaluationRunCommand)
    .build() {
}

...
exports.CreateDataQualityRulesetCommand = exports.$Command = void 0;
...
class CreateDataQualityRulesetCommand extends smithy_client_1.Command
    ...
    .f(void 0, void 0)
    .ser(Aws_json1_1_1.se_CreateDataQualityRulesetCommand)
    .de(Aws_json1_1_1.de_CreateDataQualityRulesetCommand)
    .build() {
}

...
class GetLaunchTemplateDataCommand extends smithy_client_1.Command
    ...
    .f(void 0, models_6_1.GetLaunchTemplateDataResultFilterSensitiveLog)
    .ser(Aws_ec2_1.se_GetLaunchTemplateDataCommand)
    .de(Aws_ec2_1.de_GetLaunchTemplateDataCommand)
    .build() {
}

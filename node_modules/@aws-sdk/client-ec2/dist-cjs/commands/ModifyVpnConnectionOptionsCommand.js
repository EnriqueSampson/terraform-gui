...
class ModifyVpnConnectionOptionsCommand extends smithy_client_1.Command
    ...
    .f(void 0, models_6_1.ModifyVpnConnectionOptionsResultFilterSensitiveLog)
    .ser(Aws_ec2_1.se_ModifyVpnConnectionOptionsCommand)
    .de(Aws_ec2_1.de_ModifyVpnConnectionOptionsCommand)
    .build() {
}

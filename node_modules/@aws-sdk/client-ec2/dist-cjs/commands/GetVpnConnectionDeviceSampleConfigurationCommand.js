...
class GetVpnConnectionDeviceSampleConfigurationCommand extends smithy_client_1.Command
    ...
    .f(void 0, models_6_1.GetVpnConnectionDeviceSampleConfigurationResultFilterSensitiveLog)
    .ser(Aws_ec2_1.se_GetVpnConnectionDeviceSampleConfigurationCommand)
    .de(Aws_ec2_1.de_GetVpnConnectionDeviceSampleConfigurationCommand)
    .build() {
}

...
class AttachVerifiedAccessTrustProviderCommand extends smithy_client_1.Command
    ...
    .f(void 0, models_0_1.AttachVerifiedAccessTrustProviderResultFilterSensitiveLog)
    .ser(Aws_ec2_1.se_AttachVerifiedAccessTrustProviderCommand)
    .de(Aws_ec2_1.de_AttachVerifiedAccessTrustProviderCommand)
    .build() {
}

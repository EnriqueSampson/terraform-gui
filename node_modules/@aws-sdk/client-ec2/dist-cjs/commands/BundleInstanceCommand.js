...
class BundleInstanceCommand extends smithy_client_1.Command
    ...
    .f(models_0_1.BundleInstanceRequestFilterSensitiveLog, models_0_1.BundleInstanceResultFilterSensitiveLog)
    .ser(Aws_ec2_1.se_BundleInstanceCommand)
    .de(Aws_ec2_1.de_BundleInstanceCommand)
    .build() {
}

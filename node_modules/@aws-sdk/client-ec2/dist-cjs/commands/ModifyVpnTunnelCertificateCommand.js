...
class ModifyVpnTunnelCertificateCommand extends smithy_client_1.Command
    ...
    .f(void 0, models_6_1.ModifyVpnTunnelCertificateResultFilterSensitiveLog)
    .ser(Aws_ec2_1.se_ModifyVpnTunnelCertificateCommand)
    .de(Aws_ec2_1.de_ModifyVpnTunnelCertificateCommand)
    .build() {
}

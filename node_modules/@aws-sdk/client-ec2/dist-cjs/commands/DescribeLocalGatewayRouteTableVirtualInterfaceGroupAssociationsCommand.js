...
class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsCommand extends smithy_client_1.Command
    ...
    .f(void 0, void 0)
    .ser(Aws_ec2_1.se_DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsCommand)
    .de(Aws_ec2_1.de_DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsCommand)
    .build() {
}
